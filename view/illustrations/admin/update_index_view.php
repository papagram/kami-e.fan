			...
			<div class="col col-md-6">
				<form action="<?php echo h(root_url('/illustrations/admin/update_action.php')); ?>" method="post" class="form-horizontal">
					<fieldset>
						<legend>編集</legend>
						<div class="thumb">
							<img src="<?php echo h(root_url("/illustrations/display/image_view.php?filename={$image->getFilenameThumb()}&mime={$image->getMime()}&user_id={$image->getUserId()}")); ?>" width="<?php echo h($new_w); ?>" height="<?php echo h($new_h); ?>">
						</div>
